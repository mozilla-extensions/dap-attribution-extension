...
const VALID_ACTION_TIME_MINUTES = 10080;
...
const getLastAllowedTimestamp = () => {
    const lastAllowedTime = new Date();
    lastAllowedTime.setMinutes(lastAllowedTime.getMinutes() - VALID_ACTION_TIME_MINUTES);
    return lastAllowedTime;
}